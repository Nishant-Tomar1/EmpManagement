...
function Toast() {
    ...
    <div className={`flex flex-col justify-center items-center ${theme}`}>
        ...
        {   alertCtx.toast.type === "error" &&
            <div id="toast-danger" className="flex items-center w-full max-w-xs p-4 mb-4 border-2 border-red-500 dark:border-gray-400 dark:border-2 text-gray-500 bg-white rounded-lg  shadow dark:text-gray-400 dark:bg-gray-800 " role="alert">
        ...
        {   alertCtx.toast.type === "warning" &&
            <div id="toast-warning" className="flex items-center w-full max-w-xs p-4 border-2 border-orange-500 dark:border-gray-400 dark:border-2 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        {   alertCtx.toast.type === "info" &&
            <div id="toast-info" className="flex items-center w-full max-w-xs p-4 border-2 border-blue-500 dark:border-gray-400 dark:border-2 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
